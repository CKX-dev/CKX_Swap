export const idlFactory = ({ IDL }) => {
  ...
  const Aggregator = IDL.Service({
    ...
    'caller' : IDL.Func([], [IDL.Text], []),
    'deposit_cycles' : IDL.Func([], [], []),
    'getAggregator_id' : IDL.Func([], [IDL.Principal], []),
    'getSwapId' : IDL.Func([], [IDL.Text], []),
    ...
    'setSwapId' : IDL.Func([IDL.Text], [IDL.Text], []),
    'testPrincipal' : IDL.Func([], [IDL.Text], []),
