...
export interface Aggregator {
  ...
  'getAggregator_id' : ActorMethod<[], Principal>,
  'getSwapId' : ActorMethod<[], string>,
  ...
  'removeLP' : ActorMethod<
    [Principal, Principal, bigint, bigint, bigint, Principal, bigint],
    string
  >,
  'setSwapId' : ActorMethod<[string], string>,
  'testPrincipal' : ActorMethod<[], string>,
...
export type Value = { 'Int' : bigint } |
  ...
  { 'Text' : string };
export interface _SERVICE extends Aggregator {}
