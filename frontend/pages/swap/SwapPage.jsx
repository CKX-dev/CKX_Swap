          ...
          <div className={styles.CardContainer}>
            <div className={styles.HeaderContainer}>
              ...
              <div style={{ display: 'flex', marginTop: '-10px', position: 'relative' }}>
                ...
                <svg onClick={() => setShowDropdown(!showDropdown)} style={{ marginLeft: '10px', cursor: 'pointer' }} width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className={`${styles.Dropdown} ${showDropdown ? styles.Show : ''}`}>
                  ...
                  <div style={{ display: 'flex' }}>
                    <input type="text" name="" id="" inputMode="numeric" placeholder="Auto" value={slippage} onChange={(e) => setSlippage(e.target.value)} />
